...
description: How to install SolidUI Neobrutalism theme for TanStack Router project
prev: installation/astro
prevLabel: Astro
next: installation/tanstack-start
nextLabel: TanStack Start
---

### Create New TanStack Router App

Start by creating a new TanStack Router app using `create-tsrouter-app`. Use `--interactive` and `--framework Solid` parameters to create a new Solid.js project. Select **Solid-UI** template when prompted:
