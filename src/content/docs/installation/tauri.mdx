---
title: Tauri
slug: installation/tauri
description: How to install SolidUI Neobrutalism theme for Tauri project
prev: installation/tanstack-start
prevLabel: TanStack Start
...
Start by creating a new Tauri app using `create-tauri-app`. Select **Typescript / Javascript** template when prompted which language to use for your frontend, and then select **Solid** template when prompted which UI template to use:

<NpmCommand type="create" command="tauri@latest" />
...
<NpmCommand type="install" command="tailwindcss @tailwindcss/vite class-variance-authority clsx tailwind-merge lucide-solid tw-animate-css @kobalte/tailwindcss" />
